...
To generate images:
- download [CGPart dataset](https://github.com/qliu24/render-3d-segmentation). 
...
10 example generated images and scenes are in `output/images` and `output/scenes`. `output/superCLEVR_scenes_100mb.json` contains scene info for all (25k) generated images, which is then be used to generated questions.

To generate questions, run `sh scripts/generate_questions.sh`. This bash file include several different scripts for generate questions with/without parts.
